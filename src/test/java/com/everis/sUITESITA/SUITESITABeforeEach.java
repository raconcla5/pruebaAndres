...
HashMap<String, String> BeforeEachVariable = new HashMap<String, String>();
            ...
            constant.apiResponse = realizaPOST.RealizaPOSTPOST4();
            ...
            + constant.apiResponse.jsonPath().getString("name") + ", expected " + "equals " + BeforeEachVariable.get("name"), "INFO", 0, Status.PASS, false, "Correct assertion CompruebaName4 check the Body <br><strong>return</strong> name: "  + constant.apiResponse.jsonPath().getString("name")
            ...
            + constant.apiResponse.jsonPath().getString("job") + ", expected " + "equals " + BeforeEachVariable.get("job"), "INFO", 0, Status.PASS, false, "Correct assertion CompruebaJob4 check the Body <br><strong>return</strong> job: "  + constant.apiResponse.jsonPath().getString("job")
