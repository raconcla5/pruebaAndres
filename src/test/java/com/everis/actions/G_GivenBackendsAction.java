...
public G_GivenBackendsAction postPOST3() throws IOException {
...
public G_GivenBackendsAction VerdictPost3() throws Exception {
        dependencies.isBackend = true;
            ...
            Report.reportLog(dependencies, "Correct assertion BackendAssertion16 check the Header return Content-Type: "  + apiResponse.getHeader("Content-Type")
            + ", expected contains utf-8", "INFO", 0, Status.PASS, false, "Correct assertion BackendAssertion16 check the Header <br><strong>return</strong> Content-Type: "  + apiResponse.getHeader("Content-Type")
            ...
            Report.reportLog(dependencies, "Correct assertion BackendAssertion17 check the Body return job: "  + apiResponse.jsonPath().getString("job")
            + ", expected contains leader", "INFO", 0, Status.PASS, false, "Correct assertion BackendAssertion17 check the Body <br><strong>return</strong> job: "  + apiResponse.jsonPath().getString("job")
...
public G_GivenBackendsAction getGET3() throws IOException {
          dependencies.isBackend = true;
...
public G_GivenBackendsAction VerdictGet3() throws Exception {
        dependencies.isBackend = true;
            ...
            Report.reportLog(dependencies, "Correct assertion BackendAssertion18 check the Body return support: "  + apiResponse.jsonPath().getString("support")
            + ", expected contains [text:To keep ReqRes free, contributions towards server costs are appreciated!, url:https://reqres.in/#support-heading]", "INFO", 0, Status.PASS, false, "Correct assertion BackendAssertion18 check the Body <br><strong>return</strong> support: "  + apiResponse.jsonPath().getString("support")
...
public G_GivenBackendsAction patchPATCH3() throws IOException {
          dependencies.isBackend = true;
...
public G_GivenBackendsAction VerdictPatch3() throws Exception {
        dependencies.isBackend = true;
            ...
            Report.reportLog(dependencies, "Correct assertion BackendAssertion15 check the Body return updatedAt: "  + apiResponse.jsonPath().getString("updatedAt")
            + ", expected contains 2021", "INFO", 0, Status.PASS, false, "Correct assertion BackendAssertion15 check the Body <br><strong>return</strong> updatedAt: "  + apiResponse.jsonPath().getString("updatedAt")
...
public G_GivenBackendsAction putPUT3() throws IOException {
          dependencies.isBackend = true;
...
public G_GivenBackendsAction VerdictPut3() throws Exception {
        dependencies.isBackend = true;
            ...
            Report.reportLog(dependencies, "Correct assertion BackendAssertion19 check the Body return job: "  + apiResponse.jsonPath().getString("job")
            + ", expected notContains jesus", "INFO", 0, Status.PASS, false, "Correct assertion BackendAssertion19 check the Body <br><strong>return</strong> job: "  + apiResponse.jsonPath().getString("job")
...
public G_GivenBackendsAction postErrorPOST3() throws IOException {
          dependencies.isBackend = true;
