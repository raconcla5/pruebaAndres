...
public class G_AccederalaHomePageyrAction {
    ...
    public G_AccederalaHomePageyrAction(SharedDependencies sharedDependencies) throws Exception {
    ...
    public void doG_AccederalaHomePageyrAction() throws Exception {
